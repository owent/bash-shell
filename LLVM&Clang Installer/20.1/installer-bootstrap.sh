...
function build_llvm_toolchain() {
  ...
  STAGE_BUILD_EXT_COMPILER_FLAGS=("${STAGE_BUILD_EXT_COMPILER_FLAGS[@]}" "-DLLVM_PARALLEL_LINK_JOBS=$LINK_JOBS_MAX_NUMBER" "-DBOOTSTRAP_LLVM_PARALLEL_LINK_JOBS=$LINK_JOBS_MAX_NUMBER")
