...
elseif(LLVM_USE_LINKER STREQUAL "mold")
  unset(LLVM_ENABLE_LLD)
  unset(LLVM_ENABLE_LLD CACHE)
...
if("${LLVM_TARGETS_TO_BUILD}" MATCHES "Native|X86" AND NOT LINUX_NATIVE_TARGET)
  if(CMAKE_HOST_SYSTEM_NAME STREQUAL "Linux")
    if(LLVM_DEFAULT_TARGET_TRIPLE)
      set(LINUX_NATIVE_TARGET ${LLVM_DEFAULT_TARGET_TRIPLE})
    else()
...
message("Stage2: CMAKE_HOST_SYSTEM_NAME=${CMAKE_HOST_SYSTEM_NAME}")
message("Stage2: CMAKE_HOST_SYSTEM_PROCESSOR=${CMAKE_HOST_SYSTEM_PROCESSOR}")
message("Stage2: CMAKE_HOST_SYSTEM_VERSION=${CMAKE_HOST_SYSTEM_VERSION}")
message("Stage2: LLVM_TARGETS_TO_BUILD=${LLVM_TARGETS_TO_BUILD}")
message("Stage2: LINUX_NATIVE_IS_64BIT=${LINUX_NATIVE_IS_64BIT}")
message("Stage2: LINUX_NATIVE_TARGET=${LINUX_NATIVE_TARGET}")
message("Stage2: LLVM_DEFAULT_TARGET_TRIPLE=${LLVM_DEFAULT_TARGET_TRIPLE}")
message("Stage2: LLVM_HOST_TRIPLE=${LLVM_HOST_TRIPLE}")
...
if(LLVM_DEFAULT_TARGET_TRIPLE)
  list(APPEND LINUX_SCAN_TARGETS "${LLVM_DEFAULT_TARGET_TRIPLE}")
endif()
...
list(FIND LLVM_ENABLE_PROJECTS "polly" __POLLY_index)
if(${__POLLY_index} GREATER -1)
